...
- [ ] T001 Initialize worker directory structure in src/workers/
- [ ] T002 Verify ESM configuration and scripts in package.json
...
- [ ] T003 Ensure Redis connection singleton is accessible in src/infrastructure/queue/connection.ts
- [ ] T004 Ensure BullMQ Queue instance is accessible in src/infrastructure/queue/instance.ts
- [ ] T005 [P] Create shared job validation schema in src/shared/validators/job-validator.ts
...
- [ ] T006 [P] [US1] Create NotificationProcessor class skeleton in src/workers/processor.ts
- [ ] T007 [P] [US1] Implement provider routing logic using factory in src/workers/processor.ts
- [ ] T008 [US1] Implement the send execution logic in src/workers/processor.ts
- [ ] T009 [US1] Initialize and start the BullMQ Worker in src/workers/main-worker.ts
...
- [ ] T010 [P] [US2] Implement status update to PROCESSING at start in src/workers/processor.ts
- [ ] T011 [P] [US2] Implement success logging and SENT status update in src/workers/processor.ts
- [ ] T012 [P] [US2] Implement failure logging and FAILED status update in src/workers/processor.ts
...
- [ ] T013 [US3] Implement status pre-check logic in src/workers/processor.ts
...
- [ ] T014 [P] Implement graceful shutdown (SIGTERM/SIGINT) in src/workers/main-worker.ts
- [ ] T015 Perform code cleanup and optimize imports across src/workers/
- [ ] T016 Run and validate quickstart.md local development flow
